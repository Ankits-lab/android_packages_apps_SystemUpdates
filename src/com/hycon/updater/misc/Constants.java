...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.hycon.version";
    public static final String PROP_HYCON_VERSION = "ro.modversion";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.product.system.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.hycon.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "hycon.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "hycon.updater.uri";
