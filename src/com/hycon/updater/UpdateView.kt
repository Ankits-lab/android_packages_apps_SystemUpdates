...
import com.hycon.updater.changelog.ChangelogAdapter
import com.hycon.updater.controller.UpdaterController
import com.hycon.updater.controller.UpdaterService
import com.hycon.updater.misc.*
import com.hycon.updater.model.ChangelogItem
import com.hycon.updater.model.UpdateInfo
import com.hycon.updater.model.UpdateStatus
...
class UpdateView : LinearLayout {
    ...
    fun lateInit() {
        ...
        val currentVersion = SystemProperties.get(Constants.PROP_HYCON_VERSION)
